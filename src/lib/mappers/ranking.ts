import { RankingInternal, RankingPublic, RankingRaw } from "@/src/types/ranking";
...
export function mapRankingInternalToPublic(ranking: RankingInternal): RankingPublic {
    return {
...
export function mapRankingsRawToInternal(rankings: RankingRaw[]): RankingInternal[] {
    return rankings.map((ranking) => mapRankingRawToInternal(ranking));
}
  
  export function mapRankingsInternalToPublic(rankings: RankingInternal[]): RankingPublic[] {
